...
from ..core.schemas import Box, PatternItem
...
def redact(file_bytes: bytes) -> bytes:
    """PDF 파일 단순 텍스트 기반 레닥션"""
    from ..core.redaction_rules import apply_redaction_rules
    import fitz
    ...
    redacted_text = apply_redaction_rules(text)
